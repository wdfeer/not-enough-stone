...
class GeomatterClaymore : SwordItem(GeomatterMaterial.INSTANCE, 4, 1f - 4f, FabricItemSettings()), GeomatterWeapon,
    Identifiable {
    override fun getIdName(): String = "geomatter_claymore"
    ...
    override fun getDamageIncrease(stones: Int): Float {
        return super.getDamageIncrease(stones) * 1.6f
    }
}